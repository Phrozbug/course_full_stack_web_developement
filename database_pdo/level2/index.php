               ...
               <tr>
                ...
                <?php while ($row = $series->fetch()) { ?>
                    <tr>
                         ...
                         <td><a href="edit_serie.php?id=<?php echo $row['id'] ?>">Edit data</a></td>

                    </tr>
                <?php } ?>
                <tr>
                     <td colspan="4"><a href="add_serie.php">Serie Toevoegen</a></td>
                </tr>
          </table>
          <h2>Films</h2>
          <table>
               <tr>
                    <th><a href="?orderByFilm=titel&orderFilm=<?php echo $titelNextOrder; ?>&orderBy=<?php echo $orderBy ?>&order=<?php echo $order ?>">Title</a></th>
                    <th><a href="?orderByFilm=duur&orderFilm=<?php echo $duurNextOrder; ?>&orderBy=<?php echo $orderBy ?>&order=<?php echo $order ?>">Duur</a></th>
                    <th>Details</th>
                    <th>Edit</th>
               </tr>
                <?php while ($row = $films->fetch()) { ?>
                    <tr>
                         ...
                         <td><a href="edit_film.php?id=<?php echo $row['id'] ?>">Edit data</a></td>
                    </tr>
                <?php } ?>
                <tr>
                     <td colspan="4"><a href="add_film.php">Film Toevoegen</a></td>
                </tr>
          </table>
          <br>
          <br>
