...
if (isset($_POST['submitButton'])) {
    ...
    $sql = "INSERT INTO films (titel, duur, datum_van_uitkomst, land_van_uitkomst, omschrijving, idtrailer) 
     VALUES (:titel, :duur, :datum_van_uitkomst, :land_van_uitkomst, :omschrijving, :idtrailer)";
...
<body>
    <div class="content">
        ...
        <form action="" method="POST">
            ...
            <input type="text" name="idtrailer" id="idtrailer" value=""><br><br>
